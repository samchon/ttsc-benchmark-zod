...
export const ZodString: core.$constructor<ZodString> =
  /*@__PURE__*/ core.$constructor("ZodString", (inst, def) => {
    ...
    inst.datetime = (params) =>
      inst.check(core._isoDateTime(ZodISODateTime, params as any));
    inst.date = (params) =>
      inst.check(core._isoDate(ZodISODate, params as any));
    inst.time = (params) =>
      inst.check(core._isoTime(ZodISOTime, params as any));
    inst.duration = (params) =>
      inst.check(core._isoDuration(ZodISODuration, params as any));
  });
...
>(
  ...
  if (!valueType || !(valueType as any)._zod) {
    return new ZodRecord({
      ...
      ...util.normalizeParams(
        valueType as string | core.$ZodRecordParams | undefined,
      ),
    }) as any;
  }
  return new ZodRecord({
...
export const ZodPreprocess: core.$constructor<ZodPreprocess> =
  /*@__PURE__*/ core.$constructor("ZodPreprocess", (inst, def) => {
    ZodPipe.init(inst, def);
